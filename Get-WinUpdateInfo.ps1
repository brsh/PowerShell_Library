...
try {
	...
	$message = $message + "  Error 0x80072EE2 means problems reaching/finding Update Server`r`n"
	$message = $message + "  Error 0x8024401C means a timeout (network or process) with the Update Server`r`n"
	$message = $message + "  Error 0x80040154 means the Update Agent's COM Object isn't registered`r`n"
